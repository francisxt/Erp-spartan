...
namespace ERP_SPARTAN.Data.Migrations
{
    ...
    [Migration("20200410235840_AddingFieldQuantityToInventory")]
    partial class AddingFieldQuantityToInventory
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Models.HiAccounting.Payment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Models.Models.HiAccounting.Payment", b =>
                {
                    b.HasOne("Models.Models.HiAccounting.Loan", null)
                        .WithMany("Payments")
                        .HasForeignKey("LoanId");
                });
